...
PS_params.model = 'gaussian'  # e.g.:  'powerlaw' (default), 'broken_powerlaw', 'gaussian', 'lognormal'


# PBH formation params
PBHFormation_params = p_PBHFormation()
PBHFormation_params.model = 'Musco20'                    # e.g.:  'standard' (default), 'Musco20'
PBHFormation_params.p_model.Musco20.eta = 0.1
